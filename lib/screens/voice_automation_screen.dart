...
class _VoiceAutomationScreenState extends State<VoiceAutomationScreen> {
  ...
  String _spokenText = "Press the mic and say e.g., 'Remind John tomorrow at 8am to review the contract'";
  ...
  void _listen() async {
    if (!_isListening) {
      ...
      if (available) {
        ...
        setState(() {
          _spokenText = "Voice recognition simulated: 'Send Good Morning to Mom tomorrow at 9 AM'";
          _isListening = false;
        });
      }
    } else {
  ...
  void _processVoiceCommand() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text("Voice Task Created: '$_spokenText'"),
